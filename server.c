...
int main(int argc, char* argv[]){
    ...
    phraseM phr;
    phr.taille = 3;
    phr.listeMots = malloc(sizeof(mot)*phr.taille);
    strcpy(phr.listeMots[0].m, "coucou123");
    strcpy(phr.listeMots[1].m, "Gabriel");
    strcpy(phr.listeMots[2].m, "PD");
...
*/
    //while(1){
        ...
        // CA MARCHE CA, edit : plus maintenant
        mot temp;
        strcpy(temp.m, "btrnbBGBD");

        if(send(dsc, &phr, sizeof(phr), 0)==-1){
